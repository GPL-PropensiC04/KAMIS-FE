...
// State sorting (true = Descending, false = Ascending)
...
const toggleSort = () => {
  ...
  emit("update:sortOrder", isDescending.value);
};
</script>
...
<template>
  <button
    @click="toggleSort"
    class="p-2 border border-gray-400 rounded-md hover:bg-gray-200 transition"
  >
