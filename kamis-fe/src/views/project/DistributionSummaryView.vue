        ...
        <div class="bg-[#1E3A5F] px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl font-bold text-white">Konfirmasi Data Distribusi</h1>
                <p class="text-blue-100 mt-1">Periksa kembali data distribusi sebelum mengirim</p>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Nama Aktivitas</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formData.projectName }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Nama Klien</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ getClientName(formData.projectClientId) }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Alamat Pengambilan</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formData.projectPickupAddress }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Jumlah PHL</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formData.projectPHLCount }} orang</p>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Tanggal Mulai</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formatDate(formData.projectStartDate) }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Tanggal Selesai</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formData.projectEndDate ? formatDate(formData.projectEndDate) : '-' }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Alamat Pengiriman</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formData.projectDeliveryAddress }}</p>
              </div>
              ...
              <div class="group">
                <div class="flex items-center space-x-2 mb-3">
                  ...
                  <span class="text-sm font-semibold text-gray-500 uppercase">Upah per PHL</span>
                </div>
                <p class="text-lg font-bold text-gray-900">{{ formatCurrency(formData.projectPHLPay) }}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="(asset, index) in assetList" :key="index" class="hover:bg-blue-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 text-right whitespace-nowrap">
                      <span class="text-sm font-semibold text-gray-900">{{ formatCurrency(asset.fuelCost) }}</span>
                    </td>
                    <td class="px-6 py-4 text-right whitespace-nowrap">
                      <span class="text-sm font-semibold text-gray-900">{{ formatCurrency(asset.usageCost) }}</span>
                    </td>
                    <td class="px-6 py-4 text-right whitespace-nowrap">
                    ...
                    <td colspan="6" class="px-6 py-12 text-center">
                      <div class="flex flex-col items-center space-y-3">
                        ...
                        <div class="text-center">
                          <h3 class="text-sm font-medium text-gray-700 mb-1">Tidak ada aset yang ditambahkan</h3>
                          <p class="text-xs text-gray-500">Belum ada data aset untuk ditampilkan</p>
                        </div>
                      </div>
                    </td>
                  </tr>
            ...
            <div class="space-y-6">
              ...
              <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
                <div class="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-purple-700">Total Biaya Aset</p>
                    <p class="text-xs text-purple-600">{{ assetList.length }} aset digunakan</p>
                  </div>
                </div>
              ...
              <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                <div class="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    <p class="text-sm font-medium text-blue-700">Total Upah PHL</p>
                    <p class="text-xs text-blue-600">{{ formData.projectPHLCount }} orang × {{ formatCurrency(formData.projectPHLPay) }}</p>
                  </div>
                </div>
              ...
              <div class="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-6 border border-red-200">
                <div class="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-red-600">Aset + PHL</p>
                  </div>
                </div>
              ...
              <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                <div class="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-green-600">Revenue dari proyek</p>
                  </div>
                </div>
                <p class="text-2xl font-bold text-green-800">{{ formatCurrency(formData.projectTotalPemasukkan) }}</p>
              </div>
            </div>
          </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-6 border-2 border-yellow-200">
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="text-lg font-bold text-yellow-800">Estimasi Keuntungan</p>
                    <p class="text-sm text-yellow-700">Pemasukan - Pengeluaran</p>
                  </div>
                </div>
                <div class="text-right">
                  <p class="text-3xl font-bold" :class="estimatedProfit >= 0 ? 'text-green-600' : 'text-red-600'">
                    {{ formatCurrency(estimatedProfit) }}
                  </p>
                  <p class="text-sm" :class="estimatedProfit >= 0 ? 'text-green-600' : 'text-red-600'">
