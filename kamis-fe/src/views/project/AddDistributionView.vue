        ...
        <div class="bg-[#1E3A5F] px-8 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl font-bold text-white">Buat Aktivitas Distribusi</h1>
                <p class="text-blue-100 mt-1">Lengkapi informasi untuk membuat aktivitas distribusi baru</p>
              </div>
            </div>
            ...
            <div class="space-y-6">
              ...
              <div class="group">
                ...
                <VTextBox
                  ...
                  placeholder="Masukkan nama aktivitas distribusi"
                  :required="true"
                />
              </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl border border-gray-200 overflow-hidden">
              <div class="overflow-x-auto">
                <table class="w-full">
                  ...
                  <tfoot v-if="assetList.length > 0" class="bg-gray-50">
                    <tr>
                      <td colspan="2" class="px-6 py-4 text-right font-semibold text-gray-700">Total Biaya Aset:</td>
