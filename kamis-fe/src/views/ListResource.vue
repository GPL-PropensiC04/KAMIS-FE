...
const userRole = ref<'Direksi' | 'Finance' | 'Operasional'>('Admin'); // Ubah sesuai role login
...
// Dynamic column
const showHargaJual = computed(() => userRole.value !== 'Operasional');
const showAction = computed(() => !['Direksi', 'Finance'].includes(userRole.value));
  ...
  <div class="min-h-screen bg-[#E5EAF2] p-6">
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md mb-4">
      ...
      <div class="flex justify-between mb-4">
        ...
        <VButton label="Tambah Resource" @click="goToAddResource" />
      </div>
