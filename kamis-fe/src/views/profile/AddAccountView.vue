        ...
        <div class="bg-[#1E3A5F] px-8 py-5">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-2xl font-bold text-white">Tambah Akun Baru</h1>
                <p class="text-blue-100 mt-1">Lengkapi informasi untuk membuat akun pengguna baru</p>
              </div>
            </div>
            ...
            <div class="sticky top-6">
              ...
              <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100 mb-6">
                ...
                <div class="space-y-3 text-sm">
                  ...
                  <div class="flex justify-between">
                    ...
                    <span class="font-medium text-gray-900">{{ formData.password ? '•'.repeat(formData.password.length) : '-' }}</span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-gray-600">Role:</span>
                    <span class="font-medium text-gray-900">{{ selectedRole || '-' }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <span>{{ isLoading ? 'Menambahkan...' : 'Tambah Akun' }}</span>
                </button>
              </div>
